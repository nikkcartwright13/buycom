...
/* harmony import */ var _backend_controllers_orderControllers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4358);
...
handler.use(_backend_middlewares_auth__WEBPACK_IMPORTED_MODULE_3__/* .isAuthenticatedUser */ .P, (0,_backend_middlewares_auth__WEBPACK_IMPORTED_MODULE_3__/* .authorizeRoles */ .T)("admin")).get(_backend_controllers_orderControllers__WEBPACK_IMPORTED_MODULE_4__/* .getOrder */ .iG);
handler.use(_backend_middlewares_auth__WEBPACK_IMPORTED_MODULE_3__/* .isAuthenticatedUser */ .P, (0,_backend_middlewares_auth__WEBPACK_IMPORTED_MODULE_3__/* .authorizeRoles */ .T)("admin")).put(_backend_controllers_orderControllers__WEBPACK_IMPORTED_MODULE_4__/* .updateOrder */ .Cs);
handler.use(_backend_middlewares_auth__WEBPACK_IMPORTED_MODULE_3__/* .isAuthenticatedUser */ .P, (0,_backend_middlewares_auth__WEBPACK_IMPORTED_MODULE_3__/* .authorizeRoles */ .T)("admin")).delete(_backend_controllers_orderControllers__WEBPACK_IMPORTED_MODULE_4__/* .deleteOrder */ .wH);
...
var __webpack_exports__ = __webpack_require__.X(0, [2573,9785,4358], () => (__webpack_exec__(90708)));
