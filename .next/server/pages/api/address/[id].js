...
handler.use(_backend_middlewares_auth__WEBPACK_IMPORTED_MODULE_3__/* .isAuthenticatedUser */ .P).get(_backend_controllers_addressControllers__WEBPACK_IMPORTED_MODULE_2__/* .getAddress */ .Kn);
handler.use(_backend_middlewares_auth__WEBPACK_IMPORTED_MODULE_3__/* .isAuthenticatedUser */ .P).put(_backend_controllers_addressControllers__WEBPACK_IMPORTED_MODULE_2__/* .updateAddress */ .y3);
handler.use(_backend_middlewares_auth__WEBPACK_IMPORTED_MODULE_3__/* .isAuthenticatedUser */ .P).delete(_backend_controllers_addressControllers__WEBPACK_IMPORTED_MODULE_2__/* .deleteAddress */ ._N);
...
var __webpack_exports__ = __webpack_require__.X(0, [2573,848], () => (__webpack_exec__(36150)));
